"""
Original:
https://github.com/DLR-RM/BlenderProc/blob/63531e872802b9498ebf985c6aea86ed607440e8/blenderproc/python/camera/CameraUtility.py
...
def set_stereo_parameters(
    convergence_mode: str, convergence_distance: float, interocular_distance: float
):
